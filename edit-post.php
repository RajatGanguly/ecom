...
if(isset($_GET["id"])){
    $p_id = $_GET["id"];
    $sql_item = "SELECT * FROM `items` WHERE `id`='$p_id'";
...
if(isset($_GET["cat"])){
    ...
    if($_GET["cat"] == "holiday_rental"){
        $cat = "holiday";
    }
    
    
    if($_GET["cat"] == "cars" || $_GET["cat"] == "vans" || $_GET["cat"] == "trucks" || $_GET["cat"] == "tractors" || $_GET["cat"] == "motorbikes"){
        $cat = "cars";
    }
    if($_GET["cat"] == "parts"){
        $cat = "parts";
    ...
    if($_GET["cat"] == "men_clothes" || $_GET["cat"] == "women_clothes" || $_GET["cat"] == "kids_clothes" || $_GET["cat"] == "men_footwear" || $_GET["cat"] == "women_footwear" || $_GET["cat"] == "kids_footwear"){
        $cat = "fashion";
    }
    
    
    if($_GET["cat"] == "computers_softwares" || $_GET["cat"] == "tv_dvd" || $_GET["cat"] == "video_games" || $_GET["cat"] == "mobile_phones" || $_GET["cat"] == "audio_stereo" || $_GET["cat"] == "electrical_appliance" || $_GET["cat"] == "electronic_items"){
        $cat = "electronics";
    }
    
    
    if($_GET["cat"] == "travel_tourism" || $_GET["cat"] == "transport_taxis" || $_GET["cat"] == "tuition_classes" || $_GET["cat"] == "wedding_hall" || $_GET["cat"] == "decorations" || $_GET["cat"] == "furnitures" || $_GET["cat"] == "hair_beauty" || $_GET["cat"] == "health_services"){
        $cat = "service";
    }
}
// if (isset($_POST["title"]) and isset($_POST["optradio"]) and isset($_POST["description"]) and isset($_POST["email"]) ) {
    $u_id = $_SESSION["id"];
    $title = "";
    $description = "";
    $youtube = "";
...
// move_uploaded_file($image4['tmp_name'], $image_name4);
    ...
    $sql = "UPDATE `items` SET `p_name`='$title',  `description`='$description', `youtube`='$youtube', `price`='$price', `prop_type`='$prop_type', `email`='$email', `phone`='$email', `city`='$city', `country`='$country', `monthly_weekly`='$monthly_weekly', `reg_no`='$reg_no', `make`='$make', `model`='$model', `milage`='$milage', `parts_for_vehicle`='$parts_for_vehicle', `parts_name`='$parts_name', `website`='$website' WHERE `id`='$p_id'";
...
<style>
    ...
    <section class="post-ad-content">
        <div class="container">
            <div class="row">
                ...
                <form name="" action="<?php echo $website.'/freel/esukk/edit-post.php?id='.$_GET['id'].'&cat='.$_GET['cat']; ?>" class="post-add-form" method="POST" enctype="multipart/form-data">
                    ...
                    <!-- RENT -->
                    <div class="dynamic-post-ad cat-rent" >
                        <div class="rent">
                            <div class="content-box">
                                <h3 class="sec-title">Ad Title</h3>
                                <div class="form-group fix-w-l">
                                    <label for="posting">Enter Title </label>
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="rent_title" value=<?php echo $row["p_name"] ?> >
                                </div>
                            </div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    ...
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="rent_prop_type" value=<?php echo $row["prop_type"] ?>>
                                </div>
                            </div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    ...
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="rent_bedroom" value=<?php echo $row["bedroom"] ?>>
                                </div>
                            </div>
                            ...
                            <div class="description content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    ...
                                    <textarea class="form-control" rows="5" id="comment" name="rent_description" value=<?php echo $row["description"] ?>></textarea>
                            ...
                            <div class="price content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    ...
                                    <input class="form-control contactint" placeholder="£" id="posting" type="text" name="rent_price" value="<?php echo $row["price"] ?>">
                                </div>
                            </div>
                            ...
                            <div class="youtube-link">
                                ...
                                <div class="link-box"><img src="Image/youtube-icon.png">
                                    <div class="form-group fix-w-l">
                                        <input class="form-control contactint" placeholder="" id="posting" type="text" name="rent_youtube" value=<?php echo $row["youtube"] ?>>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    ...
                                    <input class="form-control contactint" placeholder="" id="posting" type="email" name="rent_email" value=<?php echo $row["email"] ?>  >
                                </div>
                            </div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    ...
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="rent_phone" value=<?php echo $row["phone"] ?>  >
                                </div>
                            </div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    ...
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="rent_city" value=<?php echo $row["city"] ?>>
                                </div>
                            </div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    ...
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="rent_country" value=<?php echo $row["country"] ?>>
                                </div>
                            </div>
                    ...
                    <!-- SALE -->
                    <div class="dynamic-post-ad cat-sale" >
                        <div class="sale">
                            <div class="content-box">
                                <h3 class="sec-title">Ad Title</h3>
                                <div class="form-group fix-w-l">
                            ...
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    <label for="posting">Enter Property Type </label>
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="sale_prop_type" value=<?php echo $row["prop_type"] ?>>
                                </div>
                            </div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    <label for="posting">Enter Number of Bedroom </label>
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="sale_bedroom" value=<?php echo $row["bedroom"] ?>>
                                </div>
                            </div>
                            ...
                            <div class="price content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    <label for="posting">Price: </label>
                                    <input class="form-control contactint" placeholder="£" id="posting" type="text" name="sale_price" value=<?php echo $row["price"] ?>>
                                </div>
                            </div>
                            ...
                            <div class="images content-box">
                                ...
                                <div class="youtube-link">
                                    ...
                                    <div class="link-box"><img src="Image/youtube-icon.png">
                                        <div class="form-group fix-w-l">
                                            <input class="form-control contactint" placeholder="" id="posting" type="text" name="sale_youtube" value=<?php echo $row["youtube"] ?>>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your Email id</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="email" name="sale_email" value=<?php echo $row["email"] ?>>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your Phone No</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="text" name="sale_phone" value=<?php echo $row["phone"] ?>>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your city</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="text" name="sale_city" value=<?php echo $row["city"] ?>>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your country</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="text" name="sale_country" value=<?php echo $row["country"] ?>>
                                    </div>
                                </div>
                    ...
                    <!-- LAND -->
                    <div class="dynamic-post-ad cat-land" >
                        <div class="sale">
                            <div class="content-box">
                                <h3 class="sec-title">Ad Title</h3>
                                <div class="form-group fix-w-l">
                            ...
                            <div class="price content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    <label for="posting">Price: </label>
                                    <input class="form-control contactint" placeholder="£" id="posting" type="text" name="land_price" value=<?php echo $row["price"] ?>>
                                </div>
                            </div>
                            ...
                            <div class="youtube-link">
                                ...
                                <div class="link-box"><img src="Image/youtube-icon.png">
                                    <div class="form-group fix-w-l">
                                        <input class="form-control contactint" placeholder="" id="posting" type="text" name="land_youtube" value=<?php echo $row["youtube"] ?>>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    <label for="posting">Enter your Email id</label>
                                    <input class="form-control contactint" placeholder="" id="posting" type="email" name="land_email" value=<?php echo $row["email"] ?>>
                                </div>
                            </div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    <label for="posting">Enter your Phone No</label>
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="land_phone" value=<?php echo $row["phone"] ?>>
                                </div>
                            </div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    <label for="posting">Enter your city</label>
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="land_city" value=<?php echo $row["city"] ?>>
                                </div>
                            </div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    <label for="posting">Enter your country</label>
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="land_country" value=<?php echo $row["country"] ?>>
                                </div>
                            </div>
                    ...
                    <!-- HOLIDAY RENTAL -->
                    <div class="dynamic-post-ad cat-holiday" >
                        <div class="rent">
                            <div class="content-box">
                                <h3 class="sec-title">Ad Title</h3>
                                <div class="form-group fix-w-l">
                            ...
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    <label for="posting">Enter Property Type </label>
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="holiday_prop_type" value=<?php echo $row["prop_type"] ?>>
                                </div>
                            </div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    <label for="posting">Enter Number of Bedroom </label>
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="holiday_bedroom" value=<?php echo $row["bedroom"] ?>>
                                </div>
                            </div>
                            ...
                            <div class="price content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    <label for="posting">Price: </label>
                                    <input class="form-control contactint" placeholder="£" id="posting" type="text" name="holiday_price" value=<?php echo $row["price"] ?>>
                                </div>
                            </div>
                            ...
                            <div class="youtube-link">
                                ...
                                <div class="link-box"><img src="Image/youtube-icon.png">
                                    <div class="form-group fix-w-l">
                                        <input class="form-control contactint" placeholder="" id="posting" type="text" name="holiday_youtube" value=<?php echo $row["youtube"] ?>>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    <label for="posting">Enter your Email id</label>
                                    <input class="form-control contactint" placeholder="" id="posting" type="email" name="holiday_email" value=<?php echo $row["email"] ?>>
                                </div>
                            </div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    <label for="posting">Enter your Phone No</label>
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="holiday_phone" value=<?php echo $row["phone"] ?>>
                                </div>
                            </div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    <label for="posting">Enter your city</label>
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="holiday_city" value=<?php echo $row["city"] ?>>
                                </div>
                            </div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    <label for="posting">Enter your country</label>
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="holiday_country" value=<?php echo $row["country"] ?>>
                                </div>
                            </div>
                    ...
                    <!-- VEHICLES -->
                    <div class="dynamic-post-ad cat-cars" >
                        <div class="sale">
                            <div class="content-box">
                                <h3 class="sec-title">Ad Title</h3>
                                <div class="form-group fix-w-l">
                                    <label for="posting">Enter Title </label>
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="vehicle_title"  >
                                </div>
                            </div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    ...
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="vehicle_reg_no"  >
                                </div>
                            </div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    ...
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="vehicle_make"  >
                                </div>
                            </div>
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    ...
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="vehicle_model"  >
                                </div>
                            </div>
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    ...
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="vehicle_milage"  >
                                </div>
                            </div>
                            ...
                            <div class="description content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    <label for="posting">Enter product description</label>
                                    <textarea class="form-control" rows="5" id="comment" name="vehicle_description"></textarea>
                                    <p>10000 characters remaining (12 words minimum).</p>
                                    <p>Enter as much information possible; ads with detailed and longer descriptions get more views and replies!</p>
                                </div>
                            </div>
                            ...
                            <div class="price content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    <label for="posting">Price: </label>
                                    <input class="form-control contactint" placeholder="£" id="posting" type="text" name="vehicle_price" value=<?php echo $row["price"] ?>>
                                </div>
                            </div>
                            ...
                            <div class="images content-box">
                                ...
                                <div class="youtube-link">
                                    ...
                                    <div class="link-box"><img src="Image/youtube-icon.png">
                                        <div class="form-group fix-w-l">
                                            <input class="form-control contactint" placeholder="" id="posting" type="text" name="vehicle_youtube" value=<?php echo $row["youtube"] ?>>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your Email id</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="email" name="vehicle_email" value=<?php echo $row["email"] ?>>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your Phone No</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="text" name="vehicle_phone" value=<?php echo $row["phone"] ?>>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your city</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="text" name="vehicle_city" value=<?php echo $row["city"] ?>>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your country</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="text" name="vehicle_country" value=<?php echo $row["country"] ?>>
                                    </div>
                                </div>
                    ...
                    <!-- PARTS -->
                    <div class="dynamic-post-ad cat-parts" >
                        <div class="sale">
                            <div class="content-box">
                                <h3 class="sec-title">Ad Title</h3>
                                <div class="form-group fix-w-l">
                            ...
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    ...
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="parts_parts_for_vehicle"  >
                                </div>
                            </div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    ...
                                    <input class="form-control contactint" placeholder="" id="posting" type="text" name="parts_parts_name"  >
                                </div>
                            </div>                            
                            ...
                            <div class="price content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    <label for="posting">Price: </label>
                                    <input class="form-control contactint" placeholder="£" id="posting" type="text" name="parts_price" value=<?php echo $row["price"] ?>>
                                </div>
                            </div>
                            ...
                            <div class="images content-box">
                                ...
                                <div class="youtube-link">
                                    ...
                                    <div class="link-box"><img src="Image/youtube-icon.png">
                                        <div class="form-group fix-w-l">
                                            <input class="form-control contactint" placeholder="" id="posting" type="text" name="parts_youtube" value=<?php echo $row["youtube"] ?>>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your Email id</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="email" name="parts_email" value=<?php echo $row["email"] ?>>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your Phone No</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="text" name="parts_phone" value=<?php echo $row["phone"] ?>>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your city</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="text" name="parts_city" value=<?php echo $row["city"] ?>>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your country</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="text" name="parts_country" value=<?php echo $row["country"] ?>>
                                    </div>
                                </div>
                    ...
                    <!-- CLOTHES & FOOTWARE -->
                    <div class="dynamic-post-ad cat-fashion" >
                        <div class="sale">
                            <div class="content-box">
                                <h3 class="sec-title">Ad Title</h3>
                                <div class="form-group fix-w-l">
                            ...
                            <div class="price content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    <label for="posting">Price: </label>
                                    <input class="form-control contactint" placeholder="£" id="posting" type="text" name="clothes_price" value=<?php echo $row["price"] ?>>
                                </div>
                            </div>
                            ...
                            <div class="images content-box">
                                ...
                                <div class="youtube-link">
                                    ...
                                    <div class="link-box"><img src="Image/youtube-icon.png">
                                        <div class="form-group fix-w-l">
                                            <input class="form-control contactint" placeholder="" id="posting" type="text" name="clothes_youtube" value=<?php echo $row["youtube"] ?>>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your Email id</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="email" name="clothes_email" value=<?php echo $row["email"] ?>>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your Phone No</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="text" name="clothes_phone" value=<?php echo $row["phone"] ?>>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your city</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="text" name="clothes_city" value=<?php echo $row["city"] ?>>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your country</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="text" name="clothes_country" value=<?php echo $row["country"] ?>>
                                    </div>
                                </div>
                    ...
                    <div class="dynamic-post-ad cat-electronics" >
                        <div class="sale">
                            <div class="content-box">
                                <h3 class="sec-title">Ad Title</h3>
                                <div class="form-group fix-w-l">
                            ...
                            <div class="price content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    <label for="posting">Price: </label>
                                    <input class="form-control contactint" placeholder="£" id="posting" type="text" name="electronics_electrical_price" value=<?php echo $row["price"] ?>>
                                </div>
                            </div>
                            ...
                            <div class="images content-box">
                                ...
                                <div class="youtube-link">
                                    ...
                                    <div class="link-box"><img src="Image/youtube-icon.png">
                                        <div class="form-group fix-w-l">
                                            <input class="form-control contactint" placeholder="" id="posting" type="text" name="electronics_electrical_youtube" value=<?php echo $row["youtube"] ?>>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your Email id</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="email" name="electronics_electrical_email" value=<?php echo $row["email"] ?>>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your Phone No</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="text" name="electronics_electrical_phone" value=<?php echo $row["phone"] ?>>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your city</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="text" name="electronics_electrical_city" value=<?php echo $row["city"] ?>>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your country</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="text" name="electronics_electrical_country" value=<?php echo $row["country"] ?>>
                                    </div>
                                </div>
                    ...
                    <!-- SERVICE     -->
                    <div class="dynamic-post-ad cat-service" >
                        <div class="sale">
                            <div class="content-box">
                                <h3 class="sec-title">Ad Title</h3>
                                <div class="form-group fix-w-l">
                            ...
                            <!-- <div class="price content-box">
                                ...
                                <div class="form-group fix-w-l">
                                    <label for="posting">Price: </label>
                                    <input class="form-control contactint" placeholder="£" id="posting" type="text" name="services_price" value=<?php echo $row["price"] ?>>
                                </div>
                            </div> -->
                            ...
                            <div class="images content-box">
                                ...
                                <div class="youtube-link">
                                    ...
                                    <div class="link-box"><img src="Image/youtube-icon.png">
                                        <div class="form-group fix-w-l">
                                            <input class="form-control contactint" placeholder="" id="posting" type="text" name="services_youtube" value=<?php echo $row["youtube"] ?>>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your Email id</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="email" name="services_email" value=<?php echo $row["email"] ?>>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your Phone No</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="text" name="services_phone" value=<?php echo $row["phone"] ?>>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your city</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="text" name="services_city" value=<?php echo $row["city"] ?>>
                                    </div>
                                </div>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="form-group fix-w-l">
                                        <label for="posting">Enter your country</label>
                                        <input class="form-control contactint" placeholder="" id="posting" type="text" name="services_country" value=<?php echo $row["country"] ?>>
                                    </div>
                                </div>
                ...
                <!-- <input type="text" name="item_id" value="<?php $_GET['id']; ?>"> -->
               </form>
    ...
    <script>
        let cat = <?php echo $_GET["sub_category"]; ?>;
        $(document).ready(function(){
            ...
            if(cat == "computers_softwares" || cat == "tv_dvd" || cat == "video_games" || cat == "mobile_phones" || cat == "audio_stereo" || cat == "electrical_appliance" || cat == "electronic_items"){
                $(".dynamic-post-ad").css("display","none");
                $(".cat-electronics").css("display","block");
            }
